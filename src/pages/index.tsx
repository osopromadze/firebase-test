            ...
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                <h1 className="text-4xl font-extrabold tracking-tight text-center sm:text-5xl lg:text-6xl">
                  ...
                  <span className="block text-blue-200">notes</span>
                </h1>
        ...
        <div className="bg-gray-100">
          <div className="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <p className="text-sm font-semibold tracking-wide text-center text-gray-500 uppercase">
              Made with awesome technologies
            </p>
            <div className="grid items-center grid-cols-2 gap-8 mt-6 md:grid-cols-6 lg:grid-cols-5">
              <div className="flex justify-center col-span-1 md:col-span-2 lg:col-span-1">
                <object type="image/svg+xml" data="/nextjs.svg" className="w-24">
                  <Image src="/nextjs.svg" alt="NextJS" layout="fill" />
                </object>
              </div>
              <div className="flex justify-center col-span-1 md:col-span-2 lg:col-span-1">
                <object type="image/svg+xml" data="/tailwindcss.svg" className="w-48">
                  <Image src="/tailwindcss.svg" alt="TailwindCSS" layout="fill" />
                </object>
              </div>
              <div className="flex justify-center col-span-1 md:col-span-2 lg:col-span-1">
                <object type="image/svg+xml" data="/tailwindui.svg" className="w-48">
                  <Image src="/tailwindui.svg" alt="TailwindUI" layout="fill" />
                </object>
              </div>
              <div className="flex justify-center col-span-1 md:col-span-2 lg:col-span-1">
                <object type="image/svg+xml" data="/firebase.svg" className="h-12">
                  <Image src="/firebase.svg" alt="Firebase" layout="fill" />
                </object>
              </div>
              <div className="flex justify-center col-span-1 md:col-span-2 md:col-start-2 lg:col-span-1">
                <object type="image/svg+xml" data="/typescript.svg" className="h-12">
                  <Image src="/typescript.svg" alt="TypeScript" layout="fill" />
                </object>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 mt-12 gap-y-12 gap-x-6 sm:grid-cols-2">
                <p>
                  ...
                  <span className="block mt-1 text-base text-gray-300">
                    <span className="font-medium text-white">Companies</span> use laoreet amet lacus
                    nibh integer quis.
                  </span>
                </p>
                <p>
                  ...
                  <span className="block mt-1 text-base text-gray-300">
                    <span className="font-medium text-white">Countries around the globe</span> lacus
                    nibh integer quis.
                  </span>
                </p>
                <p>
                  ...
                  <span className="block mt-1 text-base text-gray-300">
                    <span className="font-medium text-white">Customer satisfaction</span> laoreet
                ...
                <p>
                  ...
                  <span className="block mt-1 text-base text-gray-300">
                    <span className="font-medium text-white">Issues resolved</span> lacus nibh
                    integer quis.
                  </span>
                </p>
              </div>
